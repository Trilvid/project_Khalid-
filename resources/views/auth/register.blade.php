...
<body class="hold-transition theme-primary bg-img" style="background-image: url({{asset('assets/back/images/auth-bg/bg-2.jpg')}})">
						...
						<div class="bg-white rounded10 shadow-lg">
							...
							<div class="p-40">
								...
								<div class="text-center">
									<p class="mt-15 mb-0">Already have an account?<a href="{{route('auth.login')}}" class="text-danger ms-5"> Sign In</a></p>
								</div>
							</div>
						</div>								
