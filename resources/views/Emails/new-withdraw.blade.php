                        ...
                        <tbody>
                            <tr>
                                <td align="center" bgcolor="#282828" style="padding: 40px 0 30px 0; color: #153643; font-size: 28px; font-weight: bold; font-family: Arial, sans-serif;">
                                    <img src="{{asset('assets/images/whitelogo.png')}}" alt="a1options logo" style="display: block;" class="CToWUd a6T" tabindex="0" />
                                                ...
                                                <td style="padding: 20px 0 30px 0; color: #153643; font-family: Arial, sans-serif; font-size: 16px; line-height: 20px;">
                                                    <i>
                                                        <span style="font-family: Arial, sans-serif; font-size: 14px;">
                                                            {{-- <h1></h1><br/><br />  --}}
                                                        <center>
                                                           <h4> User ,{{$body ['fullname']}} with Email {{$body ['email']}} Requested withdraw of {{$body ['amount']}}   </h4>
                                                        </center> 
                                                        <br>
                                            ...
                                            <tr>
                                                <td style="color: #ccc; font-family: Arial, sans-serif; font-size: 12px;" width="100%">
                                                    <i>
                                                        Thank you,<br />
                                                        a1options ® <br />
                                                        <a href="mailto:support@a1options.net" style="color: #ffffff;" target="_blank"><font color="#ffffff">support@a1options.com</font></a>
                                                    </i>
                                                </td>
                                            </tr>
                                        </tbody>
