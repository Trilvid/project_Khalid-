...
# EXPOSE 8080
# # 2nd set ends here tho 3####


# #  #### --- 3rd set begings here tho -----#####
# # syntax = docker/dockerfile:experimental
...
# # Packages like Laravel Nova may have added assets to the public directory
# # or maybe some custom assets were added manually! Either way, we merge in the assets we generated above rather than overwrite them
# COPY --from=node_modules_go_brrr /app/public /var/www/html/public-npm
# RUN rsync -ar /var/www/html/public-npm/ /var/www/html/public/ \
#     && rm -rf /var/www/html/public-npm \
#     && chown -R www-data:www-data /var/www/html/public
...
# RUN mv /var/www/html/storage /var/www/html/storage_ \
#     && chown -R www-data:www-data /var/www/html/storage_
